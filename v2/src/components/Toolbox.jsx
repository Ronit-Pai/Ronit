...
const TOOLS = [
  {
    ...
    description:
      "Googling is an art. Try to find the answer yourself first, rather than using chatgpt.",
  },
  {
    name: "YouTube",
    url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    description:
      "Ocean of knowledge, you can learn 90% of the things by yourself for free.",
  },
  {
    name: "Reddit",
    url: "https://www.reddit.com",
    description:
      "Trust me there is atleast one guy who has solution to your problem here.",
  },
  {
    name: "VS Code",
  ...
  },
  {
    ...
    url: "https://21st.dev",
    description:
      "Very beautiful components , very useful for Frontend Developers.",
  },
];
